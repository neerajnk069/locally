...
const TravellerList = () => {
  ...
  const fetchUsers = async (page, search = "", filter = "all") => {
    try {
      const response = await axiosInstance.get(
        `/travellerlist?page=${page}&limit=${limit}&search=${encodeURIComponent(
          search,
        )}&dateFilter=${filter}`,
      );
  ...
  const deleteTravellerHandler = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axiosInstance.post(`/travellerdelete/${id}`);

        const response = await axiosInstance.get(
          `/travellerlist?page=${currentPage}&limit=${limit}&search=${encodeURIComponent(
            searchTerm,
  ...
  const toggleStatus = async (id, currentStatus) => {
    try {
      ...
      await axiosInstance.post("/travellerstatus", {
        id,
        status: newStatus,
      });
          ...
          <div className="page-content">
            <div className="container-fluid">
              <div className="title-box mb-3 pb-1">
                <h4 className="mb-0 page-title">Traveller List</h4>
                  ...
                  <ol className="breadcrumb mb-0">
                    ...
                    <li className="breadcrumb-item">
                      <Link to="/" className="new">
                        <i className="ri-group-2-line me-1 new" /> Travellers
                      </Link>
                    </li>
                                  ...
                                  <tr key={user.id}>
                                    ...
                                    <td>
                                      <div className="d-flex justify-content-end">
                                        ...
                                        <button
                                          onClick={() =>
                                            deleteTravellerHandler(user.id)
                                          }
        ...
        <div className="offcanvas-body">
          {selectedUser ? (
            ...
            <div className="text-center py-5">
              ...
              <p className="mt-3 text-muted">No Traveller selected</p>
            </div>
          )}
        </div>
      </div>
