...
const EditOffers = () => {
  ...
  const fetchOffers = async () => {
    try {
      const res = await axiosInstance.get(`/allOffers`);
      if (res.data.success) {
        const offer = res.data.body.find((item) => item.id === Number(id));
        if (offer) {
          setMerchantId(offer.user_id || "");
          setTitle(offer.title || "");
          setDescription(offer.description || "");
          setDiscount_details(offer.discount_details || "");
          setTerms_conditions(offer.terms_conditions || "");
          setStart_date(offer.start_date || "");
          setEnd_date(offer.end_date || "");
        }
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axiosInstance.put(`/updateOffer/${id}`, formData);
      if (res.data.success) {
          ...
          <div className="page-content">
            <div className="container-fluid">
              <div className="title-box mb-3 pb-1">
                <h4 className="mb-0 page-title">Edit Offers</h4>
              </div>
              ...
              <div className="card">
                <div className="card-body">
                  <form onSubmit={handleSubmit}>
                    ...
                    <button className="btn btn-primary">Update Offer</button>
